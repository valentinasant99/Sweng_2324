...
_.onClick_0_g$ = function Xc_g$(click_0_g$){
  this.this$01_10_g$.registerService_0_g$.registerUser_0_g$(this.val$emailBox2_1_g$.getText_0_g$(), this.val$passwordBox3_1_g$.getText_0_g$(), new $c_g$(this, this.val$app4_1_g$));
}
;
...
_.checkRpcTokenType_0_g$ = function ye_g$(token_0_g$){
  if (!Czc_g$(token_0_g$, 1146)) {
    throw CAc_g$(new WYc_g$("Invalid RpcToken type: expected 'com.google.gwt.user.client.rpc.XsrfToken' but got '" + token_0_g$.___clazz_0_g$ + "'"));
  }
}
;
...
;
_.registerUser_0_g$ = function oaf_g$(email_0_g$, password_0_g$, callback_0_g$){
  var ex_0_g$, helper_0_g$, streamWriter_0_g$;
  helper_0_g$ = new i0c_g$(this, 'RegisterService_Proxy', 'registerUser');
  try {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/storia2024/D5203B5FF02D816405120AD4AB6F1916_sourcemap.json 
